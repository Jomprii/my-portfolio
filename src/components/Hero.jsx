    ...
    >
      ...
      <motion.div variants={stagger} initial="initial" animate="animate">
        ...
        <motion.p variants={item} style={{
          ...
          I build clean, performant software — from backend systems to polished interfaces. 
          Currently focused on full-stack web development.
        </motion.p>

        <motion.div variants={item} style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap', alignItems: 'center' }}>
          <a
            href="#projects"
            style={{
              fontFamily: 'var(--font-mono)',
